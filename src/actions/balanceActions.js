...
export const updateBalance = data => dispatch => {
  ...
  axios
    .put(`${process.env.BASE_URL}/users/updateMyBalance`, data)
    .then(response => {
...
export const reduceBalance = data => dispatch => {
  ...
  axios
    .put(`${process.env.BASE_URL}/users/reduceMyBalance`, data)
    .then(response => {
      console.log(response)
      dispatch({
        type: REDUCE_BALANCE,
...
export const setCurrentUser = () => dispatch => {
  ...
  axios
    .get(`${process.env.BASE_URL}/users/fetchUser`)
    .then(response => {
      dispatch({
...
export const payWithStripe = data => dispatch => {
  axios
    .post(`${process.env.BASE_URL}/payments`, data)
    .then(response => {
      console.log(response)
      dispatch({
        type: STRIPE_PAYMENT,
