...
class Verify extends Component {
    ...
    render() {
        ...
        return (
            <HeaderFooter>
                {!this.state.token && <div className="empty-page">
                    <p>A verification link has been sent to your mail. Follow the link to verify your account</p>
                    <button className="btnQ">Resend Link</button>
                </div>}
                {this.state.verified && <div className="empty-page">
