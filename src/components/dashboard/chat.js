...
import
 { ThemeProvider, 
  ...
  MessageList, 
  MessageText,
  FixedWrapper} from '@livechat/ui-kit'
import './chat.css'
    ...
    return(
        <HeaderFooter>
            <div className='dashboard-header'>
                <h2>Sender transaction details</h2>
            </div>
            <div className='dashboard-menu'>
            <p
              onClick={() => changeHeader('My Transactions')}
              className={state.headerText === 'My Transactions' ? '' : 'lighter'}
            >
              My Transactions
            </p>
            ...
            <p
              ...
              className={state.headerText === 'Edit Profile' ? '' : 'lighter'}
            >
              Edit Profile
            </p>
            ...
            <p
              ...
              className={state.headerText === 'My Balance' ? '' : 'lighter'}
            >
              My Balance
            </p>
            ...
            <p
              ...
              className={state.headerText === 'Support' ? '' : 'lighter'}
            >
              Support
            </p>
