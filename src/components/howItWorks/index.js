          ...
          <br />
            <h3>For Travelers:</h3>
                ...
                <li>Post your Trip (Travel Dates, Departure/Arrival
                 ...
                 or Flight number, One-way or roundtrip, regularly traveled route
            etc). </li>
            <li> A list of Senders is immediately displayed based on your
            itinerary (matched). Use in-app messenger to get in touch with
            matched Senders.</li>
            <li> PKLoop holds collateral $$ amount based on
            package dimensions/weight a Sender entered. You can Agree on app
            suggested fees or negotiate with Sender for a higher amount. Once
            agreed, submit the negotiated amount through the secure payment
            module. </li> 
            <li>Confirm delivery arrangements, (preferably public places
            such as airports) </li>  
            <li>Travel Safe, Deliver parcel, (Enter match
            code) in order to complete delivery and get paid. </li> 
            <li>Leave a rating
            for the Sender and Recipient.</li></ol>
